...
int computer_guess_number(int min, int max);
...
main(){
       ...
       printf(".-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.>>>FINISH<<<-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-\n\n\n");
       printf("computer guessed   \" %d \"   numbers\n\n", computer_guess_number_counter);
...
int computer_play(void){
     int flag = 0, flag_invalid_input = 0, finish = 0, number, min = 0, max = 1000;
     char check;
     
     do{
        number = computer_guess_number(min , max);
        printf("\nComputer's guess :    >>%d<<\n\n", number);
